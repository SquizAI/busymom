      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-bold">BusyWomen</h3>
            <p className="text-gray-300 text-sm">
              Helping busy women save time on meal planning while eating healthier
              with personalized meal plans and AI-powered recommendations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/meal-plans" className="text-gray-300 hover:text-white text-sm">Sample Meal Plans</Link></li>
              <li><Link to="/pricing" className="text-gray-300 hover:text-white text-sm">Pricing</Link></li>
              <li><Link to="/ai-assistant" className="text-gray-300 hover:text-white text-sm">AI Assistant</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-gray-300 text-sm">
                ...
                <span>support@busywomen.com</span>
              </li>
              <li className="flex items-center text-gray-300 text-sm">
                <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                  <path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" />
                </svg>
                <span>123 Healthy Street, Fitness City, FC 12345</span>
              </li>
              <li className="flex items-center text-gray-300 text-sm">
                <svg className="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 flex flex-col md:flex-row justify-between">
          <p className="text-gray-300 text-sm">
            &copy; {currentYear} BusyWomen. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0">
            <p className="text-gray-300 text-sm">
              Designed with 💜 for busy women everywhere
            </p>
          </div>
        </div>
      </div>
